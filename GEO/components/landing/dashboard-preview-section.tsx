      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-balance">
            {isEn ? "A dashboard built to" : "Un dashboard diseñado para"}{" "}
            <span className="text-gradient">{isEn ? "take action" : "tomar acción"}</span>
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto text-pretty">
            {isEn ? "Visualize your AI visibility with clear and actionable metrics." : "Visualiza tu visibilidad en IA con metricas claras y accionables."}
          </p>
        </motion.div>
            ...
            <div className="bg-card/90 rounded-xl overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                  ...
                  <DashboardStat label={isEn ? "Total Citations" : "Total Citaciones"} value="1,247" change="+156" positive />
                  <DashboardStat label={isEn ? "Average Ranking" : "Ranking Promedio"} value="#4" change="+2" positive />
                  <DashboardStat label={isEn ? "Opportunities" : "Oportunidades"} value="23" change={isEn ? "new" : "nuevo"} />
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-6 mb-6">
                  ...
                  <div className="lg:col-span-2 bg-secondary/20 rounded-xl p-4">
                    <div className="flex items-center justify-between mb-4">
                       <h4 className="font-medium text-foreground">{isEn ? "Visibility Trend" : "Tendencia de Visibilidad"}</h4>
                  ...
                  <div className="bg-secondary/20 rounded-xl p-4">
                     <h4 className="font-medium text-foreground mb-4">{isEn ? "Citations by Engine" : "Citaciones por Motor"}</h4>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-secondary/20 rounded-xl p-4">
                     <h4 className="font-medium text-foreground mb-4">{isEn ? "vs Competitors" : "vs Competidores"}</h4>
                    <div className="h-32">
                      <ResponsiveContainer width="100%" height="100%">
                  ...
                  {/* Recent activity */}
                  <div className="bg-secondary/20 rounded-xl p-4">
                     <h4 className="font-medium text-foreground mb-4">{isEn ? "Recent Activity" : "Actividad Reciente"}</h4>
                    <div className="space-y-3">
                      <ActivityItem 
                        icon={<MessageSquare className="w-4 h-4" />}
                         title={isEn ? "New citation in ChatGPT" : "Nueva citacion en ChatGPT"}
                         time={isEn ? "2h ago" : "hace 2h"}
                        positive
                      />
                      <ActivityItem 
                        icon={<TrendingUp className="w-4 h-4" />}
                         title={isEn ? "Ranking improved in Perplexity" : "Ranking mejorado en Perplexity"}
                         time={isEn ? "5h ago" : "hace 5h"}
                        positive
                      />
                      <ActivityItem 
                        icon={<ArrowUpRight className="w-4 h-4" />}
                         title={isEn ? "Content opportunity detected" : "Oportunidad de contenido detectada"}
                         time={isEn ? "1d ago" : "hace 1d"}
                      />
                    </div>
                  </div>
                </div>

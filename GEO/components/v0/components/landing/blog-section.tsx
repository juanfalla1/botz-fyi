...
const articles = [
  {
    title: "Qué es GEO en 2026: La nueva era del posicionamiento en IA",
    excerpt: "Descubre cómo ChatGPT, Gemini y AI Overviews están reemplazando el SEO tradicional y cómo las marcas ahora compiten por convertirse en la respuesta recomendada por la IA.",
    category: "Guía",
    readTime: "8 min",
    cta: "Leer artículo",
  ...
  {
    title: "SEO vs GEO: Las diferencias clave que definirán el futuro digital",
    excerpt: "Mientras el SEO optimiza buscadores tradicionales, GEO optimiza cómo los modelos de IA entienden, recomiendan y citan tu marca.",
    category: "Comparativa",
    readTime: "6 min",
    cta: "Explorar comparativa",
  ...
  },
  {
    ...
    excerpt: "Aprende estrategias reales para mejorar tu AI Visibility Score, aumentar menciones y posicionar tu empresa dentro de respuestas generativas.",
    category: "Tutorial",
    readTime: "10 min",
    cta: "Ver guía",
  ...
  {
    title: "AI Search Optimization: El futuro del marketing digital en 2026",
    excerpt: "La búsqueda impulsada por IA está transformando internet. Descubre cómo prepararte para dominar ChatGPT, Gemini y Perplexity.",
    category: "Tendencias",
    readTime: "5 min",
        ...
        >
          <div>
            ...
            >
              ...
              <span className="font-medium">Centro de Recursos GEO</span>
            </motion.div>
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { value: "2026", label: "Contenido actualizado" }
            ].map((stat, i) => (

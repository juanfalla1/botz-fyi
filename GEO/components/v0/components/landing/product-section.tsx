...
const capabilities = [
  {
    ...
    title: "Analiza visibilidad en motores de IA",
    description: "Mide cómo aparece tu marca en ChatGPT, Gemini, Perplexity y AI Overviews."
  },
  {
    icon: <Quote className="w-5 h-5" />,
    title: "Detecta menciones y citaciones",
    description: "Rastrea cada vez que un LLM menciona o recomienda tu marca."
  },
  {
    icon: <Users className="w-5 h-5" />,
    title: "Compara competidores",
    description: "Analiza cómo la IA posiciona a tu competencia vs tu marca."
  },
  {
    icon: <Lightbulb className="w-5 h-5" />,
    title: "Genera recomendaciones GEO",
    description: "Acciones específicas para mejorar tu presencia en IA."
  },
  {
    icon: <FileSearch className="w-5 h-5" />,
    title: "Identifica oportunidades de contenido",
    description: "Descubre qué contenido crear para aumentar visibilidad."
  },
  {
    icon: <RefreshCw className="w-5 h-5" />,
    title: "Monitorea cambios en rankings IA",
    description: "Alertas cuando cambia tu posicionamiento en respuestas de IA."
  }
]
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass text-sm text-muted-foreground mb-6">
            ...
            <span>AI Search Optimization Platform</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
            Botz GEO Engine es una plataforma de AI Search Optimization (GEO) que ayuda a las marcas a entender cómo aparecen en ChatGPT, Gemini, Perplexity y AI Overviews.
          </p>
        </motion.div>
              ...
              <div className="relative glass rounded-2xl p-6 border border-border/50">
                ...
                <div className="grid grid-cols-3 gap-3 mb-6">
                  ...
                  <div className="glass rounded-xl p-3 text-center">
                    ...
                    <div className="text-xs text-muted-foreground">Citaciones</div>
                  </div>
                  <div className="glass rounded-xl p-3 text-center">
                ...
                <div className="glass rounded-xl p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-sm font-medium text-foreground">Visibilidad por motor</span>
                  </div>

      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Recursos, tutoriales y soporte</p>
          </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription>{completedSteps} de {onboardingSteps.length} pasos completados</CardDescription>
                  </div>
                </div>
                ...
                {onboardingSteps.map((step) => (
                  ...
                  >
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs text-muted-foreground">Paso {step.id}</span>
                    </div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 border-t border-border">
                  <p className="text-xs text-muted-foreground text-center">
                    Tiempo de respuesta promedio: <span className="text-primary font-medium">menos de 2 horas</span>
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Guías técnicas y API</p>
                  </div>
                </div>

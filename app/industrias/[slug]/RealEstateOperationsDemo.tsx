...
export default function RealEstateOperationsDemo({ trigger, onContact }: { trigger: number; onContact: () => void }) {
  ...
  return (
    <section className={styles.section} id="real-estate-operations-demo">
      ...
      <div className={styles.videoShell}>
        ...
        <video ref={videoRef} className={styles.video} src="/botz-real-estate-operations-demo.mp4" controls muted loop playsInline preload="metadata" onPlay={() => setPlaying(true)} onPause={() => setPlaying(false)} />

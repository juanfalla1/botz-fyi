...
const ACTION_CATALOG: ActionCategory[] = [
  {
    ...
    items: [
      ...
      { id: "voice_agent", label: "Voice Agent Call", sub: "VOICE_AGENT", icon: "📞", desc: "Dapta/Vapi phone call" },
      { id: "dapta_phonecall", label: "Dapta Phone Call", sub: "DAPTA_PHONECALL", icon: "📞", desc: "Make outbound call via Dapta" },

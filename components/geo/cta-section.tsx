      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-balance">
            ...
            <span className="text-gradient">búsqueda con IA</span>?
          </h2>

          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10 text-pretty">
            Únete a las marcas que ya están optimizando su visibilidad en ChatGPT, Gemini, Perplexity y AI Overviews.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button size="lg" variant="outline" className="text-base px-8 py-6 glass border-border hover:bg-secondary">
              Agendar demo
            </Button>
          </div>

    ...
    <div className="relative mx-auto max-w-5xl">
          ...
          <div className="p-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="bg-secondary/30 rounded-xl p-4">
                <h4 className="text-sm font-medium text-foreground mb-4">Evolución de Visibilidad IA</h4>
                <div className="h-32">
              ...
              {/* Citations chart */}
              <div className="bg-secondary/30 rounded-xl p-4">
                <h4 className="text-sm font-medium text-foreground mb-4">Citaciones por Motor IA</h4>
                <div className="h-32">
                  <ResponsiveContainer width="100%" height="100%">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs text-muted-foreground">Ranking mejorado</p>
            <p className="text-sm font-semibold text-foreground">+5 posiciones</p>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-xs text-muted-foreground">Nueva citación</p>
